...
/// <summary>
///     Represents an opaque continuation token for paginating the authenticated user's list of subscribed channels.
/// </summary>
public sealed class SubscribedChannelsContinuation
{
    private const string RouteName = "subscribed_channels";

    internal SubscribedChannelsContinuation(string token, string? profileId = null, string? trackingParams = null)
    {
    ...
    /// <summary>
    ///     Imports and validates a previously exported subscribed channels continuation string.
    /// </summary>
    /// <param name="value">The exported continuation string.</param>
    /// <returns>A validated <see cref="SubscribedChannelsContinuation" /> instance.</returns>
    ...
    public static SubscribedChannelsContinuation Import(string value)
    {
        ...
        return !string.Equals(envelope.Route, RouteName, StringComparison.Ordinal)
            ...
            : new SubscribedChannelsContinuation(envelope.Token, envelope.ProfileId, envelope.TrackingParams);
    }
}